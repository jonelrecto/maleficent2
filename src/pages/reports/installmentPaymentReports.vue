...
<script>
import AllEvents from './installmentPaymentReports/installmentPaymentReportsAllEvents'
import ByEvents from './installmentPaymentReports/installmentPaymentReportsByEvent'
