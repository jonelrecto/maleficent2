...
<!--       <q-btn label="test" color="pink" class="q-mr-lg" @click="returnBatchActivity"></q-btn> -->
      <q-btn-group rounded>
      ...
      >
        ...
        <template slot="top-left" slot-scope="props">
          <h4 class="q-mr-lg">Upcoming Schedule</h4>
    ...
    computed: {
      ...
      getModels () {
        try {
          ...
          if (type !== 'orientation') {  
            let attendanceList = this.returnAttendanceList(id,title)
            console.log('activity models',attendanceList)
